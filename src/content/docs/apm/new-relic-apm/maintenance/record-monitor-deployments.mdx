...
5. Go to **[one.newrelic.com](https://one.newrelic.com) > ([account dropdown](/docs/using-new-relic/welcome-new-relic/get-started/glossary#account-dropdown)) > Account settings** and click **Deploy notifications** in the **Integrations** section.
6. Paste the Slack webhook URL into the **Webhook URL** field, then click **Integrate with webhooks**.
